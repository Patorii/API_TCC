...
5 - Ainda no terminal digite sem as aspas "npm i" (para instalar as dependencias) após concluir o processo, digite sem as aspas "npm run dev", pronto a API já está rodando.
6 - Crie outro terminal no VsCode e digite sem as aspas "cd .\front\" e tecle enter.
7 - Ainda nesse terminal digite sem as aspas "npm i" após concluir o processo, digite sem as aspas "npm start".
8 - Pronto agora o front-end (o site) já está rodando também.